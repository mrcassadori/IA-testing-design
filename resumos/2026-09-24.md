# Curadoria de Design, UX & Produto — 2026-09-24

> Gerado em 2026-09-24 12:24 UTC | 0 artigos selecionados
...
Este problema persiste desde pelo menos 2026-09-23. O acesso de saída a domínios externos está sendo negado pelo proxy configurado na sessão remota do Claude Code.
...
**Ação necessária:** Para habilitar este resumo diário, é preciso atualizar a política de egresso da sessão no Claude Code para permitir acesso a esses domínios externos. Consulte a configuração do ambiente em https://code.claude.com/docs/en/claude-code-on-the-web.
