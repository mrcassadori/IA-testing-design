# Curadoria de Design, UX & Produto — 2026-07-24

> Gerado em 2026-07-24 12:05 UTC | 0 artigos selecionados
...
O ambiente de execução remoto aplica uma política de egresso que bloqueia conexões HTTPS a domínios externos não autorizados. Isso afetou tanto o script Python (`urllib.request`) quanto o WebFetch.
